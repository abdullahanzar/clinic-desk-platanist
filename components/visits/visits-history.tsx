    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="flex flex-col gap-4 mb-6 sm:mb-8">
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
          ...
          {role === "frontdesk" && isToday && viewMode === "day" && (
            <Link
              href="/visits/new"
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:items-center sm:justify-between bg-white rounded-xl border border-slate-200 p-3">
          {/* View Mode Toggle */}
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-2">
              {viewMode === "day" ? (
                <input
                  ...
                  className="px-3 py-2 border border-slate-200 rounded-lg text-sm font-medium text-slate-700 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent"
                />
              ) : (
                <input
                  type="month"
            ...
            <button
              ...
              className="p-2 rounded-lg text-slate-600 hover:bg-slate-100 transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
        ...
        {visits.length > 0 && (
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            ...
            <div className="bg-brand-50 rounded-xl p-3 border border-brand-100">
              <p className="text-2xl font-bold text-brand-700">{stats.inConsultation}</p>
              <p className="text-xs text-brand-600">In Consultation</p>
            </div>
                  ...
                  <div className="bg-slate-50 px-4 py-3 border-b border-slate-200 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-500">{formatDateShort(date)}</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                  ...
                  <div className="divide-y divide-slate-100">
                    ...
                    {dayVisits.length > 5 && (
                      <button
                        ...
                        className="w-full px-4 py-3 text-sm text-brand-600 hover:bg-brand-50 transition-colors text-center font-medium"
                      >
