...
const fullContent = `import type { Metadata } from "next";
...
export const metadata: Metadata = {
  ...
  description:
    "An open-source OPD clinic management system. Visits, prescriptions, and billing. Self-host or use our cloud platform.",
};
...
fs.writeFileSync('app/page.tsx', fullContent, 'utf-8');
